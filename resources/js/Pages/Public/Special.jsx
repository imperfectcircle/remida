...
/**
 *
 * TODO Form per Special
 * TODO Inserire video e foto
 */
...
export default function Special() {
    ...
    return (
        <>
            <Head>
                <title>
                    REMIDA VARESE - Innoviamo con creatività | Progetti Speciali
                </title>
            ...
            <PublicLayout>
                <section className="special grid h-screen grid-cols-1 bg-black/60 p-5 md:mt-[100px] md:grid-cols-2 md:p-0 lg:mt-0">
                    <div className="flex items-center justify-center text-white">
                        ...
                        >
                            <span className="font-bold">Progetti Speciali</span>

                            <p className="mt-5 text-xl md:text-2xl">
                                Installazioni interattive, creazioni artistiche
                                e laboratori creati su misura, in collaborazione
                                con vari Enti, per{' '}
                                <strong>rendere unico l’evento</strong> a cui
                ...
                >
                    <div className="mx-auto max-w-7xl py-10 text-2xl">
                        <p>
                            Hanno collaborato con noi BAM Milano, Fuori Salone
                            del Mobile Milano, Mandala Experience, Design week
                            Varese, Comune di Germignaga, Comune di Besozzo,
                            Camera di Commercio Varese, Comune di Gavirate,
                            Festival Microcosmi di Comerio, IBSA Lugano,
                            Alzheimer Fest aps
                        </p>
                    </div>
                </motion.section>
