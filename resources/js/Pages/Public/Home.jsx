                    ...
                    <div className="flex flex-col items-center justify-center text-white">
                        ...
                        >
                            ...
                            <span className="mt-2 text-xl md:text-2xl">
                                ...
                                finalità educative, ambientali ed artistiche.{' '}
                                <br /> Remida Varese attinge al metodo
                                pedagogico ”
                                <a
                ...
                >
                    <div className="max-w-xl p-5 text-center md:p-0">
                        ...
                        >
                            ...
                            è un monastero benedettino del XII secolo in stile
                            romanico.
                            <br />
                    ...
                    <div className="flex flex-col items-center justify-center bg-slate-500 p-10">
                        ...
                        <div className="grid grid-cols-1 justify-items-center p-2 md:p-10">
                            <p className="text-2xl text-white md:text-4xl">
                                ...
                                e per il prelievo di materiale non strutturato
                                dall'emporio dei Materiali. I Laboratori
                                creativi per famiglie aprono con calendario
                                stagionale (vedere le{' '}
                                <Link
                                    href={route('events')}
                                    className="text-white underline"
                                >
